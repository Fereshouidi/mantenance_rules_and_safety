...
export const street = {
    ...
    risks: { 
        ...
        chemical: {
            ...
            examples: [
                ...
                `تشم ابخرة سامة وقت الخدمة في بلاصة ما فيهاش تهوية باهية.`,
        ...
        noise: {
            ...
            examples: [
                ...
                `كي تكثر من استعمال ال"impact wrenches" ولا بالـ"compressed air" . (الله غالب ماعنيش فكرة على اساميهم بالعربي)`,
        ...
        fireExplosion: {
            ...
            description: `الانشطة الصيانية كيما اللحام و الطحن تعمل تشاش و برشا سخانة كبيرة تكون مصدر اشتعال قوي . و كي يكون فما وقود ولا مذيبات ولا حتى غبار قابل للاشتعال كيما اللوح ولا المعادن ينجم يعمل حرايق سريعةالانتشار ولا حتى انفجارات خطيرة.`,
            examples: [
                `كي التشاش يجي على شليقة متع متع زيت ولا مذيبات`,
            ...
            prevention: {
                ...
                examples: [
                    ...
                    `استعمل التأريض ضد الكهرباء الساكنة كي دجي تنقل في المازوط ولا المذيبات.`,
    ...
    list: [
        ...
        },
        {
            ...
            eplaination: "قبل ما تدخل ترحي و بره لازمك تعمل شوية إجراءات بسيطة كيما انك تهوي البلاصة بالقدا و تتفقد الغازات و لازم يكون فما شكون لبرا يعس عليك."
        },
        {
            title: "النظافة والترتيب (Housekeeping)",
        ...
        {
            title: "ممارسات السلامة الكهربائية (Electrical Safety Practices)",
            eplaination: "لازمك قبل ما تمس أي حاجة فاها كورون تسل الفيشة مالبريز و تستعمل أدوات عازلة ماذابيك تعمل فحوصات دورية مرة قداش."
        },
        {
