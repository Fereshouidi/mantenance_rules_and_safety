...
export const arabic = {
    ...
    risks: { 
        ...
        electrical: {
            ...
            subtitle: `خطر الصعق الكهربائي، القوس الكهربائي، والوفاة.`,
...
export const street = {
    ...
    introduction: {
        partOne: `السلامة في الشغل هي مجموعة من القوانين والإجراءات اللي تحمي العمال من الخطر أثناء عملهم. وفي مجال الصيانة الصناعية، هالإجراءات مهمة بالذات عشان التعامل المباشر مع الكهرباء، والمكاين الميكانيكية، والكيماويات، والضجيج.`,
        partTwo: `الالتزام بالسلامة مو بس يحمي حياة العمال، بس يساعد بعد في استمرار الإنتاج، وتقليل الأعطال، وتخفيف الخسائر. الإحصائيات تقول إن أكثر من 70% من حوادث المصانع نقدر نتجنبها بتطبيق احتياطات بسيطة زي لبس معدات الحماية.`,
        partThree: `هذا المشروع هدفه يوضح أهم المخاطر في الصيانة الصناعية، وكيف نتجنبها، عشان ننشر ثقافة الشغل الآمن بين الفنيين والمتدربين.`,
    },
    risks: { 
        label: `المخاطر`,
        electrical: {
